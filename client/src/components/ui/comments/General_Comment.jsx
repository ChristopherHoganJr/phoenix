...
const General_Comment = ({
  ...
  const UnLikeComment = (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setComments[idx] = { author, createdAt, text, dislike, like, _id };
        setComments([...comments]);
      })
      .catch((err) => console.log(err));
  };
  ...
  const UnDislikeComment = (e) => {
    e.preventDefault();
    axios
      .put(
        `/api/comment/undislike/${_id}`,
        {
          author,
          createdAt,
          text,
